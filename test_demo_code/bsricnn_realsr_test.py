...
from data_loader.burstsr_test_dataset import BurstSRTestDataset
...
test_img_folder = 'track2_test_set/' # testset LR images path
out_dir = 'sr_results_track2_test_set/' # save images path
...
# loading test data
test_dataset = BurstSRTestDataset(root=test_img_folder, burst_size=burst_size)
