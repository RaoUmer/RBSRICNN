...
from data_loader.synthetic_burst_test_set import SyntheticBurstVal
...
test_img_folder = 'track1_test_set/' # testset LR images path
out_dir = 'sr_results_track1_test_set/' # save images path
...
# loading test data
test_dataset = SyntheticBurstVal(root=test_img_folder)
